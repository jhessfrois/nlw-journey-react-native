...
export default function TripDetails() {
  ...
  const tripId = useLocalSearchParams<{ id: string }>().id; // Pega o tripId da URL
  ...
  return (
    <View className="flex-1 px-5 pt-16">
      <Input variant="tertiary">
        ...
        <TouchableOpacity
          activeOpacity={0.6}
          className="w-9 h-9 bg-zinc-800 items-center 
      ...
      {option === "activity" ? <Activities tripDetails={tripDetails} /> : <Details />}
